...
import { filesFromPath, Web3Storage } from 'web3.storage';
import { useState, useEffect } from 'react';
import { useAccount, useContract, useSigner } from "wagmi";
import { CONTRACT_ADDRESS, CONTRACT_ABI } from './contract';


const client = new Web3Storage({token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweERGOGQ4OTQ3MTkyN2M5Nzc2MThiMDAwZDk5Mjc5MjU3Mjc4NDA4NjQiLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2NzQ4MTI3MDIwMTYsIm5hbWUiOiJGaWxlU3RvcmdlIn0.8Wjv0Kb8wMIpQvUQcfIR8iezE8uzilLPEO4Iph80pv4"})
